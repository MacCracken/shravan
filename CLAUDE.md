...
11,572-assertion suite is 1116 / 138 / 10318 across the three. `cyrius distlib`
...
./scripts/test-all.sh                       # build + run ALL three test binaries (11,572 assertions)
...
2. Cleanliness check: `./scripts/test-all.sh` (builds all three harnesses), verify all 11,572 assertions pass
