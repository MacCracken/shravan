...
11,601-assertion suite is 1145 / 138 / 10318 across the three. `cyrius distlib`
...
./scripts/test-all.sh                       # build + run ALL three test binaries (11,601 assertions)
...
2. Cleanliness check: `./scripts/test-all.sh` (builds all three harnesses), verify all 11,601 assertions pass
